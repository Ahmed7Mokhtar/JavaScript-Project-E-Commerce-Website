...
function showCard(eachCard) {
    ...
    card.innerHTML = `<div class="photo">
                ...
                <div>
                    <a href="" onclick="addToCart(${eachCard.id}, '${eachCard.name}', '${eachCard.price}', '${eachCard.category}')"><i class='fa fa-shopping-bag'></i></a>
                </div>
            </div>`;
...
function addToCart(prdId, prdName, prdPrice, prdCat) {
    var cartProducts = {};
